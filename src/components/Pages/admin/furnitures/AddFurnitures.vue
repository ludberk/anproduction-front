        ...
        <div class="overview">
          ...
          <div class="boxes">
            <div class="box box1">
              ...
              <span class="number">
                <UploadFurnitures @image-uploaded="fetchImages" />
              </span>
            </div>
            <div class="box box1">
...
import UploadFurnitures from './UploadFurnitures.vue'
import UpdateFurnitures from './UpdateFurnitures.vue'
...
export default {
  ...
  methods: {
    async fetchImages() {
      try {
        const response = await axios.get('http://backend-0s8d.onrender.com/api/furnitures/images')
    ...
    async deleteImage(id) {
      try {
        await axios.delete(`http://backend-0s8d.onrender.com/api/furnitures/images/${id}`)
        await this.fetchImages()
      } catch (error) {
